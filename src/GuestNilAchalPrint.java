...
public class GuestNilAchalPrint implements Printable,Serializable {
	...
	public int print(Graphics graphics, PageFormat pageFormat, int pageIndex) throws PrinterException {
	      ...
	      if (pageIndex < 0 || pageIndex >= 1) {
		        ...
		        g2d.drawString("Nil Achal" ,50, 15);
		        g2d.setFont(total);
		        g2d.drawString("Roton Corner, Malotinagar High School Lane, Bogra" ,10, 34);
		        g2d.drawString("cell: 01718050575" ,70, 44);
		        g2d.drawString("Invoice: "+GuestWindow.invoiceField.getText() ,76, 54);
		        g2d.drawString(nDtFormat.format(new Date()),10, 54);
		        g2d.drawString(dateFormat.format(new Date()),162,54);
		        g2d.drawRect(10, 58, 186, 24);
		        if(!GuestWindow.nameTextField.getText().equals(null) && !GuestWindow.nameTextField.getText().equals(""))
		        {
		        	g2d.drawString(GuestWindow.nameTextField.getText(), 12, 68);
		        	g2d.drawString(GuestWindow.cellTextField.getText(), 135, 68);
		        }
		        else{
		        ...
		        int y=113;
		        g2d.setColor(Color.BLACK);
		        for(int i=0;i<GuestWindow.soldItems.size();i++)
		        {
		        	g2d.drawString("1.", 15, y);
			       	g2d.drawString(GuestWindow.soldItems.elementAt(i).barcode, 29,y);
			       	g2d.drawString(GuestWindow.soldItems.elementAt(i).name, 23,y+9);
			       	g2d.drawString(GuestWindow.soldItems.elementAt(i).quantity+" ps",100,y);
			    	g2d.drawString(GuestWindow.soldItems.elementAt(i).totalSellPrice,180,y);
			    	y+=22;
		        }
		        ...
		        g2d.drawString(GuestWindow.totalAmount.getText(), 150,(y+8));
		        g2d.drawString("tk", 185, y+8);
		        g2d.drawString("Cash Received", 35,(y+18));
		        g2d.drawString(":", 122,(y+18));
		        g2d.drawString(GuestWindow.rcvdTextField.getText(), 150, y+18);
		        g2d.drawString("tk", 185, y+18);
		        g2d.drawString("Change", 35,(y+28));
		        g2d.drawString(":", 122,(y+28));
		        g2d.drawString(GuestWindow.changeField.getText(), 150, y+28);
    ...
    public static void main(String[] args) {
    	   ...
    	   Printable printable = new GuestNilAchalPrint();
