...
public class EidReceiptWithoutCash implements Printable,Serializable {
	...
	public int print(Graphics graphics, PageFormat pageFormat, int pageIndex) throws PrinterException {
	      ...
	      Graphics2D g2d = (Graphics2D) graphics;
	        ...
	        g2d.setFont(mail);
	        g2d.drawString("EID MUBARAK", 70, 15);
	        g2d.setFont(header);
	        g2d.setColor(Color.BLACK);
	        //g2d.drawLine(10, 20,170,20);
	        g2d.drawString("Birds Eye" ,50, 35);
	        g2d.setFont(total);
	        g2d.drawString("Roton Corner, Malotinagar High School Lane, Bogra" ,10, 54);
	        g2d.drawString("cell: 01732127666" ,70, 64);
	        g2d.drawString("Invoice: "+AdminWindow.invoiceField.getText() ,76, 74);
	        g2d.drawString(nDtFormat.format(new Date()),10, 74);
	        g2d.drawString(dateFormat.format(new Date()),162,74);
	        g2d.drawRect(10, 80, 186, 24);
	        if(!AdminWindow.nameTextField.getText().equals(null) && !AdminWindow.nameTextField.getText().equals(""))
	        {
	        	g2d.drawString(AdminWindow.nameTextField.getText(),12,90);
	        }
	        else{
	        	g2d.drawString("Default", 12, 90);
	        }
	        g2d.drawString("Sold by "+Login.user, 12,100);
	        g2d.setFont(item);
	        g2d.drawString("MUSAK-11 KA (694988710826)", 102,100);
	        g2d.setFont(total);
	        g2d.drawLine(10,108,196,108);
	        g2d.drawString("No |", 12,118);
	        g2d.drawString("Product Desription", 60,118);
	        g2d.drawString("Amount", 147,118);
	        g2d.drawLine(10,123,196,123);
	        int y=133;
	        g2d.setColor(Color.BLACK);
	        for(int i=0;i<AdminWindow.soldItems.size();i++)
	        {
	        	g2d.drawString((i+1)+".", 15, y);
		    	...
		    	g2d.drawString(AdminWindow.soldItems.elementAt(i).totalSellPrice,160,y);
		    	y+=22;
	        }
	        ...
	        g2d.drawString(AdminWindow.totalAmount.getText(), 160,(y+8));
	        g2d.drawString("tk", 185, y+8);
	        g2d.drawString("Cash Received", 35,(y+18));
	        g2d.drawString(":", 122,(y+18));
	        g2d.drawString(AdminWindow.rcvdTextField.getText(), 160, y+18);
	        g2d.drawString("tk", 185, y+18);
	        g2d.drawString("Change", 35,(y+28));
	        g2d.drawString(":", 122,(y+28));
	        g2d.drawString(AdminWindow.changeField.getText(), 160, y+28);
    ...
    public static void main(String[] args) {
    	   ...
    	   Printable printable = new EidReceiptWithoutCash();
