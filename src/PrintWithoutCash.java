...
public class PrintWithoutCash implements Printable,Serializable {
	...
	public int print(Graphics graphics, PageFormat pageFormat, int pageIndex) throws PrinterException {
	      ...
	      if (pageIndex < 0 || pageIndex >= 1) {
		        ...
		        g2d.drawString(AdminWindow.totalAmount.getText(), 150, y+18);
    ...
    public static void main(String[] args) {
    	   ...
    	   Printable printable = new PrintWithoutCash();
