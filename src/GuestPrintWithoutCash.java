...
public class GuestPrintWithoutCash implements Printable,Serializable {
	...
	public int print(Graphics graphics, PageFormat pageFormat, int pageIndex) throws PrinterException {
	      ...
	      if (pageIndex < 0 || pageIndex >= 1) {
		        ...
		        g2d.drawString(GuestWindow.totalAmount.getText(), 150, y+18);
		        g2d.drawString("tk", 185, y+18);
		        g2d.drawString("Change", 35,(y+28));
		        g2d.drawString(":", 122,(y+28));
		        g2d.drawString("0", 150, y+28);
    ...
    public static void main(String[] args) {
    	   ...
    	   Printable printable = new GuestPrintWithoutCash();
