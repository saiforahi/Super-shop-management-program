...
public class CustomerCheck {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
						CustomerCheck window = new CustomerCheck();
	 ...
	 * @throws SQLException 
	 */
	public CustomerCheck() throws SQLException {
		initialize();
	}
	...
	private void initialize() throws SQLException {
		...
		frmCustomers.setLocationRelativeTo(AdminWindow.frmBirdsEye);
		...
		comboBox.setBounds(3, 45, 278, 29);
		setNameComboModel();
		...
		lblName.setBounds(47, 11, 203, 29);
		panel.add(lblName);
		...
		lblCellNumber.setBounds(348, 11, 194, 29);
		...
		comboBox_1.setBounds(327, 43, 240, 29);
		...
		table.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if(e.getKeyCode()==KeyEvent.VK_ENTER)
				{
					...
					AdminWindow.nameTextField.setText(model.getValueAt(table.getSelectedRow(), 0).toString());
					AdminWindow.cellTextField.setText(model.getValueAt(table.getSelectedRow(), 1).toString());
					AdminWindow.pointField.setText(model.getValueAt(table.getSelectedRow(), 4).toString());
